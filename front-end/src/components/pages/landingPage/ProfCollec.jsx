...
const ProfCollec = () => {
  return (
    <>
   <div className='prof h-screen'>
  <div className="overlay"></div>
  <div className="flex flex-col md:flex-col md:w-full h-screen lg:flex-col  w-full md:p-5 lg:p-5 mt-20 text-white">
    <div className="flex flex-col mt-20 ">
    <div className="flex text-black">YOUR DREAM AWAITS</div>
    <div className="flex pt-5 md:text-5xl text-2xl text-black">Professional <span className='ml-2 border-b border-b-8 border-cyan-800 text-black'>Collections</span></div>
...
<div className="b1  ml-2 flex flex-col text-white md:w-full h-1/4 md:h-3/4 md:w-1/4">
  ...
  <div className="caption mt-2 text-black">LIMESTONE</div>
</div>
<div className="b1 flex flex-col text-white md:w-full h-1/4 md:h-3/4 md:w-1/4">
  ...
  <div className="caption mt-2 text-black">MARBLE</div>
    </div>
    <div className="b1 flex flex-col text-white md:w-full h-1/4 md:h-3/4 md:w-1/4">
  <img src={bg} className='h-3/4 hover:transform hover:rotate-3 transition-transform duration-300' alt="bg" />
  <div className="caption mt-2 text-black">GLACIER SPLIT FACE CLADDING</div>

</div>
<div className="b1 flex flex-col text-white md:w-full h-1/4 md:h-3/4 md:w-1/4">
  <img src={bg} className='h-3/4 hover:transform hover:rotate-3 transition-transform duration-300' alt="bg" />
  <div className="caption mt-2 text-black">DECORATIVE & MOSAIC TILES</div>
</div>
