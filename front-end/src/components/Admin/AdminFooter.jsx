   ...
   <footer className="bg-white dark:bg-white">
       <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-10">
         ...
         <div className="sm:flex sm:items-center sm:justify-between">
             <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Himlaya Enterprises</a>. All Rights Reserved.
             </span>
