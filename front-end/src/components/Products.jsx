...
const Products = () => {
  return (
    <section
      id="products"
      className="products-section bg-gray-100 py-10 px-4 h-80vh overflow-y-auto"
    >
      <div className="container mt-16 mx-auto flex flex-col items-center justify-center md:mt-16">
        <div className="text-white text-3xl md:text-5xl font-bold opacity-50 mb-2 md:mb-4 font-thin tracking-wider animate__animated animate__fadeInLeft">
          Our Products
        </div>
        <div className="text-white text-lg md:text-xl mt-8 text-center">
          Explore our wide range of high-quality marble products. From classic
      ...
      <Link to="/products">
        <div className="box-1 text-xl w-screen mt-8 flex items-center justify-center">
          <div className="btn btn-one">Browse Products</div>
        </div>
      </Link>
    </section>
  );
